...
int main(int argc, char** argv) {
    ...
    // priv_node.param<double_t>("scan2_deg_threshold", px_drone_control.scan2_deg_threshold_, 1);
    // priv_node.param<double_t>("scan2_dis_diff_threshold", px_drone_control.scan2_dis_diff_threshold_, 0.05);
    // priv_node.param<double_t>("scan2_dis_threshold", px_drone_control.scan2_dis_threshold_, 0.5);
    // priv_node.param<double_t>("scan2_const_vel", px_drone_control.scan2_const_vel_, 0.3);
    // priv_node.param<double_t>("scan2_const_distance", px_drone_control.scan2_const_distance_, 3.0);
    // priv_node.param<double_t>("scan2_ratio_altitude", px_drone_control.scan2_ratio_altitude_, 0.5);
    ...
    // priv_node.param<double_t>("connection_stop_time", px_drone_control.Threshold_Distance, 0.5);
    // priv_node.param<double_t>("connection_stop_time", px_drone_control.Threshold_Distance, 0.5);
    ros::Rate rate(100);
