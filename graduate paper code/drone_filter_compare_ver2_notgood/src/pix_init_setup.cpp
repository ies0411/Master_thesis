...
bool PXDroneControl::Init_Set(void) {
    ...
    P_EKF = 10.0 * Eigen::MatrixXf::Identity(6, 6);
    Q_EKF = 0.001 * Eigen::MatrixXf::Identity(6, 6);
    ...
    P_UKF = 10.0 * Eigen::MatrixXf::Identity(6, 6);
    Q_UKF = Eigen::MatrixXf::Identity(6, 6);  // Q(6,6)=0.2;
    R_UKF = Eigen::MatrixXf::Identity(6, 6);
